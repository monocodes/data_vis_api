...
url = 'https://api.github.com/search/repositories?q=language:typescript&sort=stars'
...
offline.plot(fig, filename='results/TRY IT YOURSELF/typescript_repos.html')